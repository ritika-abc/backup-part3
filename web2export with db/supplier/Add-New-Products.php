...
$sql = "INSERT INTO `product`( `cat_id`, `sub_cat_id`, `mco_id`, `product`, `username`, `price`, `unit`, `Warranty`, `Diameter`, `Condition`, `Features`, `Supply_type`, `filename`, `search`) VALUES ('$cat_id','$sub_cat_id','$mco_id','$product','$username','$price','$unit','$Warranty','$Diameter','$Condition', '$Features', '$Supply_type','$filename','product')";
              ...
              <form class="row g-3"  method="POST"  enctype="multipart/form-data">
               ...
               <!-- </div>-->
                  <div class="col-md-4">
                       ...
                       <div class="col-md-4">
                       <select id="state-dropdown" class="form-select form-control" name="mco_id">

                       <?php
                            require_once "connection.php";
                            $result = mysqli_query($conn, "SELECT * FROM  mco_category");
                            while ($row = mysqli_fetch_array($result)) {
                            ?>
                ...
                <div class="col-md-12">
                     <textarea class="form-control" placeholder="Details" name="Features" id="floatingTextarea" style="height: 100px;"></textarea>
                </div>
