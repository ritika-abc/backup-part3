...
$username = $_GET["username"];
 ...
 ?>   
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 py-2">
                           <a href="category.php?search=product&mco_id=<?php echo $row['mco_id'];?>&username=<?php echo $_GET["username"];?>" class="border">
                                <figure>
                                    <span>
                                        <img style="height:220px; width:300px;"  src="admin/image/<?php echo $row['mco'];?>" alt="Category image">
                                    </span>
                                </figure>
 ...
 if(isset($_GET['username']))
$username = $_GET["username"];
      $sql = "SELECT `product_id`, `cat_id`, `sub_cat_id`, `mco_id`, `product`, `username`, `price`, `unit`, `Warranty`, `Diameter`, `Condition`, `Features`, `Supply_type`, `filename`, `date_created`, `search` FROM `product` WHERE username='$username' LIMIT 12";
  $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        // output data of each row
    while($row = $result->fetch_assoc()) {
 ...
 ?>      
  <div class="col-6 col-md-4 col-lg-2">
                        ...
                        </div><!-- End .col-sm-6 col-md-4 col-lg-3 -->  <?php
                   } }
              ?>   
