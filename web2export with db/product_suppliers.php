...
INNER JOIN supplier ON supplier.username=product.username)
 WHERE  product.mco_id= '$mco_id' AND product.Supply_type='supplier'";
 ...
 ?>   
            <a href="product_suppliers.php?data&mco_id=<?php echo $row['mco_id'];?>"><p class="line"><?php echo $row['mco_category'];?> </p></a>	    
          <?php
                } }
          ?> 
                </table>
