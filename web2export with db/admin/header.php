...
?>
   ...
   if(isset($_SESSION["user"])){
      ...
      $sql = "SELECT `admin_id`, `username`, `password`, `date_created` FROM `admin` WHERE username='$username' ";
  ...
  <header id="header" class="header fixed-top d-flex align-items-center bg-info">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">WEB2EXPORT</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar bg-info-subtle">
    ...
    <!--  <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Location</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="New-Supplier-Request.php">
              <span>New Supplier Request</span>
            </a>
          </li>
         
          <li>
            <a href="All-Suppliers.php">
      ...
      <li class="nav-item">
        ...
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="Add-New-Buyleads.php">
              <span>Add New Buyleads</span>
            </a>
          </li>
